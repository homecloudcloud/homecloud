...
def check_directories():
    ...
    required_dirs = ['/var/lib/immich', '/etc/immich']
...
def get_immich_status():
    ...
    service_running = check_service_status('immich.service')
...
def main():
    ...
    hostname = f"https://{base_hostname}:2284"
    api_endpoint = f"{hostname}/api"
