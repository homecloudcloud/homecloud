...
VERSION_CACHE_FILE = "/var/cache/homecloud/linshare.ver.json"
...
def get_linshare_api_endpoint() -> Optional[str]:
...
def get_current_version() -> Optional[str]:
    ...
    try:
        ...
        with open('/etc/linshare/docker-compose.yaml', 'r') as f:
            ...
            image = compose_data['services']['ui-user']['image']
            if ':' in image:
...
def fetch_github_version() -> Optional[str]:
    ...
    try:
        # Run omv-rpc command
        cmd = ["omv-rpc", "-u", "admin", "Homecloud", "linshare_get_latest_version"]
