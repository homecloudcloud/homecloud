...
import { CompleteLogoHeaderComponent } from './complete-logo-header/complete-logo-header.component';
import { TopBarWizardComponent } from './top-bar-wizard/top-bar-wizard.component';
...
@NgModule({
  declarations: [
    ...
    LogoHeaderComponent,
    CompleteLogoHeaderComponent,
    TopBarWizardComponent
