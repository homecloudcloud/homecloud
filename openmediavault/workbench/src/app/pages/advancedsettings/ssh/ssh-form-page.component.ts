    ...
    hints: [
      {
        type: 'info',
        text: gettext(
          'Enable console access to Homecloud using SSH over local network (not accessible on VPN). Caution: This may increase security risk and changing settings via console may cause Homecloud to stop working. Enable only if you understand risks.'
        ),
        dismissible: false,
