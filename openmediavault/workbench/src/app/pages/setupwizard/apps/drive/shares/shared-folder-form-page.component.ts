  ...
  public config: FormPageConfig = {
    ...
    fields: [
      ...
      },
      {
        ...
        hint: gettext('The disk on which the shared folder is to be created.'),
        valueField: 'uuid',
      ...
      },
      {
        ...
        modifiers: [
          ...
          {
            type: 'hidden',
            constraint: { operator: 'eq', arg0: { value: '1' }, arg1: { value: '1' } }
          }
        ],
        validators: {
          required: true
