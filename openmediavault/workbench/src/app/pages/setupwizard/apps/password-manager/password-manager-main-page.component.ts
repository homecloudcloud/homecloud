...
export class AppsPasswordManagerMainComponent extends BaseFormPageComponent {
  ...
  ngAfterViewInit(): void {
    ...
    setTimeout(() => {
      this.enableNavButtons(); // Enable the buttons in the navigation bar
  ...
  updateFieldVisibility(status:string):void{
    ...
    const passwordManagerMainForm2=document.querySelector('omv-setupwizard-password-manager-main-page #password-manager-main-form2');
    const passwordManagerMainForm3=document.querySelector('omv-setupwizard-password-manager-main-page #password-manager-main-form3');
        ...
        */
        execute: {
          ...
          request:{
            ...
            params:{
              'lastCompletedStepName':'appsPasswordManager',
            },
            successUrl:'/setupwizard/apps/media',
          }
        }
