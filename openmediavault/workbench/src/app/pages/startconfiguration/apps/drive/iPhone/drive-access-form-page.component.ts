...
@Component({
  selector:'omv-drive-access-iphone-page', //Home cloud changes
  template: `
...
export class AppsDriveAccessComponent extends BaseFormPageComponent {
  ...
  addSanitizedHtml(){
    ...
    const paragraphs5 = document.querySelectorAll('#ios-drive-form5 .omv-form-paragraph');

    paragraphs5[4].innerHTML =
