...
@Component({
  selector:'omv-drive_reset-page', //Home cloud changes
  //template: '<omv-intuition-form-page [config]="this.config"></omv-intuition-form-page>',
  template: `
  <omv-intuition-form-page id="drive-reset-form1" [config]="this.config"></omv-intuition-form-page>
  `,
  styleUrls: ['./drive_reset-page.component.scss'],
  encapsulation: ViewEncapsulation.None  // This will disable view encapsulation
})

export class AppsDriveResetComponent extends BaseFormPageComponent {
  private htmlContent=`<div class="container">
                        <h1>🧹 Reset Drive</h1>
                        <p>
                        Need a fresh start? This will reset your <strong>Drive</strong> and remove all Drive users, shares and their stored data.
                        </p>

                        <div class="warning">
                        ⚠️ <strong>WARNING:</strong><br />
                        This will <strong>DELETE ALL drive data</strong>, including:
                        <ul>
                        <li> Users</li>
                        <li> Data</li>
                        <li> Any shares created</li>
                        </ul>
                        🚫 <strong>This cannot be undone!</strong>
                        </div>

                        <p class="backup-tip">💾 Please take a <strong>Drive backup</strong> before proceeding 🛡️</p>
       ...
       // class:'omv-background-color-pair-primary',
        ...
        execute: {
          ...
          request: {
            ...
            progressMessage: 'Resetting Drive',
            successNotification: 'Deleted Drive users, shares and data',
  ...
  constructor(private sanitizer: DomSanitizer) {
      ...
      ngAfterViewInit() {
        setTimeout(() => {
          ...
          const paragraphs = document.querySelectorAll('omv-drive_reset-page omv-form-paragraph .omv-form-paragraph');
