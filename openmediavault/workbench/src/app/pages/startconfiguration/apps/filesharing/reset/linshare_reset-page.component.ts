...
@Component({
  selector:'omv-linshare_reset-page', //Home cloud changes
  //template: '<omv-intuition-form-page [config]="this.config"></omv-intuition-form-page>',
  template: `
  <omv-intuition-form-page id="linshare-reset-form1" [config]="this.config"></omv-intuition-form-page>
  `,
  styleUrls: ['./linshare_reset-page.component.scss'],
  encapsulation: ViewEncapsulation.None  // This will disable view encapsulation
})

export class AppsLinshareResetComponent extends BaseFormPageComponent {
  private htmlContent=` <div class="container">
                        <h1>🧹 Reset Linshare</h1>
                        <p>
                        Want a fresh start? This will <strong>reset</strong> your Linshare setup by
                        <strong>removing all users and their notes</strong> 📄.
                        </p>
                        </div>`;
   ...
   constructor(private sanitizer: DomSanitizer) {
      ...
      ngAfterViewInit() {
        setTimeout(() => {
          ...
          const paragraphs = document.querySelectorAll('omv-linshare_reset-page omv-form-paragraph .omv-form-paragraph');
