...
@Component({
  selector:'omv-jellyfin_reset-page', //Home cloud changes
  //template: '<omv-intuition-form-page [config]="this.config"></omv-intuition-form-page>',
  template: `
  <omv-intuition-form-page id="jellyfin-reset-form1" [config]="this.config"></omv-intuition-form-page>
  `,
  styleUrls: ['./jellyfin_reset-page.component.scss'],
  encapsulation: ViewEncapsulation.None  // This will disable view encapsulation
})

export class AppsJellyfinResetComponent extends BaseFormPageComponent {
  private htmlContent=` <div class="container">
                        <h1>🧹 Reset Jellyfin</h1>
                        <p>
                        Want a fresh start? This will <strong>reset</strong> your Jellyfin setup by
                        <strong>removing all users and configuration</strong> 📄.
                        </p>

                        <div class="warning">
                        ⚠️ <strong>Note:</strong> This will not delete your media files as they are stored in Drive app.
                        <br />
                        </div>
                        </div>`;
    ...
    buttons: [
      {
       ...
       // class:'omv-background-color-pair-primary',
        ...
        execute: {
          ...
          request: {
            service: 'Homecloud',
            method: 'reset_jellyfin',
            task: false, // Set to true if this is a long-running task
            progressMessage: 'Resetting Jellyfin',
            successNotification: 'Deleted users and configuration',
   ...
   constructor(private sanitizer: DomSanitizer) {
      ...
      ngAfterViewInit() {
        setTimeout(() => {
          ...
          const paragraphs = document.querySelectorAll('omv-jellyfin_reset-page omv-form-paragraph .omv-form-paragraph');
