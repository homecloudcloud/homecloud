...
@Component({
  selector:'omv-jellyfin-restore-page', //Home cloud changes
  //template: '<omv-intuition-form-page [config]="this.config"></omv-intuition-form-page>',
  // <omv-intuition-form-page id="notes-restore-form1" [config]="this.config"></omv-intuition-form-page>
  template: `
  <div id="jellyfin-restore-form1">
    <div class="omv-form-paragraph" [innerHTML]="safeHtmlContent"></div>
  </div>
  <omv-intuition-datatable-page id="jellyfin-restore-data-form" [config]="this.config1"></omv-intuition-datatable-page>
  `,
  styleUrls: ['./jellyfin-restore-page.component.scss'],
  encapsulation: ViewEncapsulation.None  // This will disable view encapsulation
})

export class AppsJellyfinRestoreComponent extends BaseFormPageComponent {
  ...
  public config1: DatatablePageConfig = {
    ...
    stateId: '32z2n8zz-5thj-11ea-0624-s4eml1sd8f63',
    autoReload: false,
    remoteSorting: true,
    remotePaging: true,
    sorters: [
    ...
    actions: [
      {
        ...
        enabledConstraints: {
          ...
          message: gettext(
            'Backup will OVERWRITE the existing configuration including users and all their metadata.'
          )
        },
        execute: {
          type: 'taskDialog',
          taskDialog: {
            config: {
              ...
              request: {
                service: 'Homecloud',
                method: 'jellyfin_restore_execute',
                params:{
