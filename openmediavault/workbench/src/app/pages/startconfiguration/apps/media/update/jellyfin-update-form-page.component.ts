...
export class AppsJellyfinUpdateFormPageComponent extends BaseFormPageComponent {
  ...
  public config: FormPageConfig = {
    ...
    fields: [
     ...
     
      {
        type: 'textInput',
        name: 'status',
        label: gettext('New updates for Jellyfin backend service'),
        hint: gettext(''),
        value: '',
        readonly: true
      },
      ...
      },
      {
        ...
        hint: gettext('Jellyfin backend service latest available version'),
        value: '',
        readonly: true
      },
      {
        ...
        hint: gettext('By checking this box, you agree to update Jellyfin to latest version'),
        value: '',
        readonly: false
      }
    ],
    ...
    fields: [
      {
        type: 'textInput',
        name: 'status',
        label: gettext('Auto updates for Jellyfin backend'),
        hint: gettext(''),
        value: '',
        readonly: true
      }
  ...
  updateFieldColors(status:string):void{
    const element = document.querySelector('omv-jellyfin-update-page omv-form-text-input:nth-of-type(1) .mat-form-field input');
    if(element){
