...
@Component({
  selector:'omv-joplin_reset-page', //Home cloud changes
  //template: '<omv-intuition-form-page [config]="this.config"></omv-intuition-form-page>',
  template: `
  <omv-intuition-form-page id="joplin-reset-form1" [config]="this.config"></omv-intuition-form-page>
  `,
  styleUrls: ['./joplin_reset-page.component.scss'],
  encapsulation: ViewEncapsulation.None  // This will disable view encapsulation
})

export class AppsJoplinResetComponent extends BaseFormPageComponent {
  private htmlContent=` <div class="container">
                        <h1>🧹 Reset Joplin</h1>
                        <p>
                        Want a fresh start? This will <strong>reset</strong> your Joplin setup by
       ...
       // class:'omv-background-color-pair-primary',
        ...
        execute: {
          ...
          request: {
            ...
            progressMessage: 'Resetting Joplin',
   ...
   constructor(private sanitizer: DomSanitizer) {
      ...
      ngAfterViewInit() {
        setTimeout(() => {
          ...
          const paragraphs = document.querySelectorAll('omv-joplin_reset-page omv-form-paragraph .omv-form-paragraph');
