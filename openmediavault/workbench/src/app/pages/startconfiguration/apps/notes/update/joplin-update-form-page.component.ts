...
@Component({
  ...
  template: `<div id="joplin-update-form1">
                <div class="omv-form-paragraph" [innerHTML]="safeHtmlContent"></div>
              </div>
              <omv-intuition-form-page id="joplin-update-form2"[config]="this.config"></omv-intuition-form-page>
              <div id="joplin-update-form3">
                <div class="omv-form-paragraph" [innerHTML]="safeHtmlContent1"></div>
              </div>
             <omv-intuition-form-page id="joplin-update-form4"[config]="this.config2"></omv-intuition-form-page>`,
...
export class AppsJoplinUpdateFormPageComponent extends BaseFormPageComponent {
  ...
  private htmlContent= `
            <div class="update-section">
              ...
              <p>
              📋 Before updating, please <a href="https://github.com/laurent22/joplin" class="plainLink" target="_blank">review the release notes</a> for important information.
              </p>
  ...
  ngOnInit():void{
    this.rpcService.request('Homecloud', 'appAutoUpdates',{
      ...
      this.buttonText = response.status === 'enabled' ? 'Disable Auto updates for Joplin backend' : 'Enable Auto updates for Joplin backend';
  ...
  updateFieldVisibility(status:string):void{
    const checkbox=document.querySelector('omv-joplin-update-page omv-form-checkbox');
