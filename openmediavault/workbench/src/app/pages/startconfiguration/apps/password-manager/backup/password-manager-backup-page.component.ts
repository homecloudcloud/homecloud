      ...
      this.htmlContent= `
            <div class="backup-container">
              ...
              <div class="backup-box">
                ...
                <p class="icon-text">
                🔓 Remember: Vaultwarden data is encrypted by default and backed up in its encrypted form.
                </p>
                <p class="icon-text">
                  📦 <strong class="backupSizeText">Estimated VaultWarden backup size(in GB):</strong><span class="backupSize">${this.totalGb}</span>
                </p>
                <p class="icon-text">
