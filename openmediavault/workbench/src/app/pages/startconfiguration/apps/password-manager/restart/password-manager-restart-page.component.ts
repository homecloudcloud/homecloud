  ...
  public config: FormPageConfig = {
    ...
    fields: [
    ...
    
      {
        ...
        hint: gettext('If service is down then you would not be able to use Bitwarden mobile or web app'),
        value: '',
        readonly: true
      }
    ],
    buttons: [
      {
        text: 'Restart Vaultwarden Backend Service',
        disabled:false,
        submit:true,
