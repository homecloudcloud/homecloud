...
@Component({
  selector:'omv-photos-access-page', //Home cloud changes
  template: `
  ...
  `,
  styleUrls: ['./photos-access-form-page.component.scss'],
  encapsulation: ViewEncapsulation.None  // This will disable view encapsulation
})



export class AppsPhotosAccessComponent extends BaseFormPageComponent {
      ...
      this.htmlContent = `
        <div>
          ...
          <div class="status-message ${this.photosStatus !== 'Running' ? '' : 'hidden'}">
            <span class="status-deploy-message ${this.photosStatus !== 'Not deployed' ? 'hidden' : ''}" >App is not deployed. Go to <a class="plainLink" href="#/startconfiguration/apps/photos">photos main page</a> to deploy the app. </span>
            <span class="status-not-running-message ${this.photosStatus !== 'Running' && this.photosStatus !== 'Not deployed' ? '' : 'hidden'}" >App is not running currently. Go to <a class="plainLink" href="#/startconfiguration/apps/photos/restart">photos status page</a> to check the status or restart the app. </span>
          </div>
