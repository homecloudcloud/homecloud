  ...
  private htmlContent = `
    <div class="content-wrapper">
      <div class="left-column">
        ...
        <p>After deploying, go to the <a class="plainLink" href="#/startconfiguration/apps/photos/access">access page</a> to start using the app.</p>
      </div>
...
`;
 ...
 constructor(private rpcService: RpcService,private sanitizer: DomSanitizer) {
  ...
  //  console.log('deploy status',status);
    const checkboxDeploy=document.querySelector('omv-photos-main-page #photos-main-form2 omv-form-checkbox');
    const checkboxRemove=document.querySelector('omv-photos-main-page #photos-main-form3 omv-form-checkbox');
